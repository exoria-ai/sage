...
Returns document metadata, section list, and chunk counts.`,
    ...
    // Search General Plan Tool
    server.tool(
      'search_general_plan',
      `Search the 2008 Solano County General Plan documents.
...
12: Suisun Marsh LPP`,
      ...
      async ({ query, top_k, document_type, chapter, chunk_type }) => {
    ...
    // Get General Plan Chunk Tool
    server.tool(
      'get_general_plan_chunk',
      `Retrieve the full text of a specific General Plan chunk by ID.
...
Use after search_general_plan to get complete text of a result.`,
    ...
    // List General Plan Chapters Tool
    server.tool(
      'list_general_plan_chapters',
      `List all chapters in the 2008 General Plan.
...
Returns chapter numbers, titles, and chunk counts for each chapter.`,
    ...
    // List General Plan Documents Tool
    server.tool(
      'list_general_plan_documents',
      `List all document types in the General Plan collection.
...
Use this to understand what documents are available for searching.`,
    ...
    // Get General Plan Chapter Tool
    server.tool(
      'get_general_plan_chapter',
      `Get all content from a specific General Plan chapter.
...
Useful for reading an entire chapter or section.`,
    ...
    // Get General Plan Overview Tool
    server.tool(
      'get_general_plan_overview',
      `Get overview statistics about the General Plan document collection.
...
Use this to understand what's available before searching.`,
    ...
    // Search General Plan Policies Tool
    server.tool(
      'search_general_plan_policies',
      `Search specifically for policies and goals in the General Plan.
