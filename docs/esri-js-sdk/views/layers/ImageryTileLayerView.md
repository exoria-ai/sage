...
**Module:** `@arcgis/core/views/layers/ImageryTileLayerView`

## Import

```javascript
import ImageryTileLayerView from "@arcgis/core/views/layers/ImageryTileLayerView.js";
```
...
- ImageryTileLayer
- Sample - Hosted Land Cover ImageryTileLayer
- suspended
