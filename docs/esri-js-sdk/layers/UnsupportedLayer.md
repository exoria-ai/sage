...
**Module:** `@arcgis/core/layers/UnsupportedLayer`

## Import

```javascript
import UnsupportedLayer from "@arcgis/core/layers/UnsupportedLayer.js";
```

```javascript
// CDN
const UnsupportedLayer = await $arcgis.import("@arcgis/core/layers/UnsupportedLayer.js");
```
