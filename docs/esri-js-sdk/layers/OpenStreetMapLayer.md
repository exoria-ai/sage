...
**Module:** `@arcgis/core/layers/OpenStreetMapLayer`
...
```javascript
// CDN
const OpenStreetMapLayer = await $arcgis.import("@arcgis/core/layers/OpenStreetMapLayer.js");
```
